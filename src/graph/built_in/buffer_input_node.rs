...
impl BufferInputNode {
    /// Creates a new instance of the BufferInputNode.
    pub fn new() -> Self {
        BufferInputNode {
            id: NodeId::new_v4(),
...
impl Clone for BufferInputNode {
    fn clone(&self) -> Self {
        BufferInputNode {
            id: self.id.clone(),
